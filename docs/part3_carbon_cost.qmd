...
# water/built-up - 0
landcover <- rast(file.path("data/landcover/landcover_1km.tif"))
...
# they are the same
carbon <- bms_carbon + resample(soct_1m, bms_carbon)
names(carbon) <- "carbon_cost"
writeRaster(carbon, file.path(rlt_dir, "carbon_cost.tif"))
```
