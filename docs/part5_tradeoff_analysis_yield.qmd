---
title: "Part5: tradeoff analysis with mean yield as factor"
author: "Lei Song"
editor: visual
toc: true
toc-depth: 2
...
result_dir <- here("results_yield_factor")
...
fnames <- fnames[!str_detect(fnames, "mean_attainable_yield")]
template <- rast(fnames[1]) %>% crop(bry) %>% mask(bry)

fnames_80 <- fnames[!str_detect(fnames, "60")]
fnames_80[5] <- file.path(trdeoff_dir, "mean_attainable_yield.tif")
...
fnames_60[5] <- file.path(trdeoff_dir, "mean_attainable_yield.tif")
...
fnames_60_half[5] <- file.path(trdeoff_dir, "mean_attainable_yield.tif")
...
cbetas_bcep <- c(
    ...
    "elephant_cons_index" = 1/5, "attainable_yield" = 1/5, 
    "travel_time" = 1/5)
...
cbetas_bcp <- c(
    ...
    "elephant_cons_index" = 0, "attainable_yield" = 1/4,
    "travel_time" = 1/4)
...
cbetas_bce <- c(
    ...
    "elephant_cons_index" = 0, "attainable_yield" = 1/2,
    "travel_time" = 1/2)
